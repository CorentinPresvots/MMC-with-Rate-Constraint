    ...
    def MMC_enc(self, x, x_previous, n_max):
        ...
        for n_x in Nx:
            ...
            if SNR_model >= 0:
                ...
                # Iterate over residual encoding methods
                for id_residual_test in self.best_Residual_used:
                    # Calculate the remaining bits for residual encoding
                    n_r = n_max - self.nm - self.best_Model_used[id_model]["n kx"] - self.best_Model_used[id_model]["n nx"] - nx_model - self.nl - self.best_Residual_used[id_residual_test]["n kr"] - self.best_Residual_used[id_residual_test]["n nr"]
    
                    if n_r >= 0:
                        # Encode the residual and compute the residual SNR
                        ...
                        if SNR_model + SNR_residual_test > SNR_tot:
                            ...
                            # Store the best model and residual configurations
                            ...
                            self.best_Model_used[id_model]["nx"] = nx_model
