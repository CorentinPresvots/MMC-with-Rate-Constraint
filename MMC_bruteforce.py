...
class Encode_one_window(Model_Encoder, Residual_Encoder):
    ...
    def MMC_enc(self, x, x_previous, n_max):
        ...
        for id_model_test in self.best_Model_used:
            ...
            max_rate_per_parameter=np.min([70+fact,1+np.min([self.nb_max_bit_theta*len(self.best_Model_used[id_model_test]["w theta"]),2**self.best_Model_used[id_model_test]["n nx"]-1])])
            ...
            for n_x in Nx:
                ...
                for id_residual_test in self.best_Residual_used :   
                    ...
                    n_r=n_max-self.nm-self.best_Model_used[id_model_test]["n kx"]-self.best_Model_used[id_model_test]["n nx"]-n_x-self.nl-self.best_Residual_used[id_residual_test]["n kr"]-self.best_Residual_used[id_residual_test]["n nr"]
                    ...
                    if n_r>=0:
                        ...
                        if SNR_model_test+SNR_residual_test>SNR_tot  :
                            ...
                            self.best_Model_used[id_model_test]["nb sym residual"]=nb_sym_test
